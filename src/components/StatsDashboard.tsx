...
const TopVenuesCard: React.FC<TopVenuesCardProps> = ({ venues }) => {
...
const YearDistributionChart: React.FC<YearDistributionChartProps> = ({
  yearData,
}) => {
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  height: {
                    xs: `${Math.max(((yearData[year] || 0) / maxCount) * 45, 4)}px`,
